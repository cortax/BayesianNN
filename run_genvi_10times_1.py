...
if __name__ == "__main__":
    ...
    GeNVIs = ["-m Experiments.GeNVI --max_iter=50000 --n_samples_ED=50 --n_samples_LP=100 --lat_dim=5 --layerwidth=50 --learning_rate=0.08 --patience=1000 --lr_decay=.8 --verbose=1 --device=cuda:" + j + " --setup=" + i for i,j in datasets]
