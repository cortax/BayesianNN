...
################ EXPERIENCE 1 ####################
    ...
    MFVIs_params = [(10000,0.05,100) for i in range(7)]
    
    # (max_iter, learning_rate, patience)
    GeNVIs_params = [(10000,0.05,100) for i in range(7)]
...
################ EXPERIENCE 2 ####################
 ...
 # (max_iter, ensemble_size)
    ...
    # (max_iter, learning_rate, patience)
    MFVIs_params = [(15000,0.05,500) for i in range(7)]
    
    # (max_iter, learning_rate, patience)
    GeNVIs_params = [(15000,0.05,500) for i in range(7)]
