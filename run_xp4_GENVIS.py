...
# (max_iter, ensemble_size)
    ...
    GeNVIs = ["-m Experiments.GeNVI --max_iter=" + str(p[0]) + " --learning_rate=" + str(p[1]) + " --patience=" + str(p[2]) + " --n_samples_ED=10 --n_samples_LP=10 --verbose=1 --device=cuda:" + j + " --setup=" + i for i,j,k,l,p in datasets]
