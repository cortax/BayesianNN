...
def main(get_data,get_model,sigma_noise,experiment_name,nb_split,ensemble_size,init_std, max_iter, learning_rate, min_lr, patience, lr_decay,  device, verbose):
                    ...
                    with mlflow.start_run(run_name='component', nested=True):
                        ...
                        for t in range(max_iter-1):
                            ...
                            if lr < min_lr:
                                break
                            if verbose:
                                stats = 'Split {}.Run {}. Epoch [{}/{}], Training Loss: {}, Learning Rate: {}'.format(split,k,t, max_iter, L, lr)
                                print(stats)
