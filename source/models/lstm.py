...
class IndexLSTMModel(nn.Module):
    def __init__(self, amount_features,
        ...
        super().__init__()
        self.lstm = nn.LSTM(input_size=amount_features,
        ...
        self.predict_layer = nn.Linear(hidden_size * num_layers * (bidirectional + 1), number_classes)
    ...
    def forward(self, input):
        ...
        gru_out, (h_n, c_n) = self.lstm(input)
