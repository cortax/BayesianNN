...
def full_base_lstm_training(index_dataset, experiment_number, amount_datasets,
    ...
    folder_string = 'baseLSTMModel/{}/experiment{}'.format(dataset_name_string, experiment_number)
    ...
    print('Making Model')
    model = IndexLSTMModel(features_amount, labels_type, size_windows, hidden_size, num_layers, 
...
def train_base_lstm_main(experiment_number, amount_datasets,
                            n_epoch, batch_size, sampler_type,
                            early_stop, patience, cooldown, factor, learning_rate, verbose, threshold,
                            features_amount, labels_type, size_windows, normalize,
                            split_train_test_ratio, split_train_valid_ratio,
    ...
    for index_dataset in range(amount_datasets):
        #print(index_dataset)
        test_loss, test_metrics = full_base_lstm_training(index_dataset, experiment_number, amount_datasets,
                                            n_epoch, batch_size, sampler_type,
                                            early_stop, patience, cooldown, factor, learning_rate, verbose, threshold,
                                            features_amount, labels_type, size_windows, normalize,
                                            split_train_test_ratio, split_train_valid_ratio,
