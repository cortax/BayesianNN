...
def full_base_training(index_dataset, experiment_number, amount_datasets,
    ...
    folder_string = 'baseGruModel/{}/experiment{}'.format(dataset_name_string, experiment_number)
...
def train_base_gru_main(experiment_number, amount_datasets,
                            n_epoch, batch_size, sampler_type,
                            early_stop, patience, cooldown, factor, learning_rate, verbose, threshold,
                            features_amount, labels_type, size_windows, normalize,
                            split_train_test_ratio, split_train_valid_ratio,
    ...
    for index_dataset in range(amount_datasets):
        #print(index_dataset)
        test_loss, test_metrics = full_base_training(index_dataset, experiment_number, amount_datasets,
                                            n_epoch, batch_size, sampler_type,
                                            early_stop, patience, cooldown, factor, learning_rate, verbose, threshold,
                                            features_amount, labels_type, size_windows, normalize,
                                            split_train_test_ratio, split_train_valid_ratio,
