...
class FeaturesIndexOnlyDataset(data.Dataset):
...
def get_multiple_features_multiple_datasets(number_subdatasets, size_windows, signal_type,
    ...
    for chunk in range(number_subdatasets):
        ...
        train_dataset = FeaturesIndexOnlyDataset(_train, signal_type)
        valid_dataset = FeaturesIndexOnlyDataset(_valid, signal_type)
        test_dataset = FeaturesIndexOnlyDataset(_test, signal_type)
...
def multiple_features_multiple_datasets_main(dataset_name_string,
                                    number_subdatasets,
