...
if __name__ == "__main__":
    ...
    parser.add_argument("--temperatures", type=str, default='1.0, 1.4, 1.7, 2.05, 2.45, 3., 3.2, 3.5, 4.1, 4.8, 5.5, 6.4, 7.7, 9., 11., 13.7, 17.5, 24., 35., 48.0, 81.2, 137.7, 233.6, 396.8, 674.1, 1145.6',
