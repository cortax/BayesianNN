...
def log_GeNVI_experiment(setup,  n_samples_FU, ratio_ood, the_epoch, the_scores, log_scores,
                         lat_dim, 
                         kNNE, n_samples_KL, n_samples_LL, 
                         max_iter, learning_rate, min_lr, patience, lr_decay,
                         device, save_best):
...
if __name__ == "__main__":
    ...
    with mlflow.start_run():
        log_GeNVI_experiment(setup, args.n_samples_FU, args.ratio_ood, the_epoch, the_scores, log_scores,
                             args.lat_dim, 
                             args.NNE, args.n_samples_KL, args.n_samples_LL,
