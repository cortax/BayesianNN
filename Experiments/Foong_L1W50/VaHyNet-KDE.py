...
def main(ensemble_size=1,lat_dim=5,activation=nn.ReLU(),init_w=.15,init_b=.001,KDE_prec=2.,n_samples_KDE=10000,n_samples_ED=50, n_samples_LP=50, max_iter=10000, learning_rate=0.001, min_lr=0.0005, patience=100, lr_decay=0.9,  device='cpu', verbose=False):
