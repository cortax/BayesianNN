...
if __name__ == "__main__":    
    ...
    main(data.get_data, data.get_model, data.sigma_noise, data.experiment_name, data.nb_split, args.ensemble_size,
         args.max_iter, args.learning_rate, args.min_lr,  args.n_samples_ED, args.n_samples_LP,  args.patience,
         args.lr_decay, args.init_std, args.optimize, seed, device, args.verbose,args.show_metrics)
