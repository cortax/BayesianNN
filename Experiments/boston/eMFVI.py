...
def main(ensemble_size=1, max_iter=100000, learning_rate=0.01, min_lr=0.0005,  n_samples_ED=50, n_samples_LP=50, patience=100, lr_decay=0.9, init_std=1.0, optimize=0, seed=-1, device='cpu', verbose=0):
    seeding(seed)

    xpname = experiment_name + '/eMFVI'
...
if __name__ == "__main__":
    ...
    main(args.ensemble_size, args.max_iter, args.learning_rate, args.min_lr,  args.n_samples_ED, args.n_samples_LP,  args.patience, args.lr_decay, args.init_std, args.optimize, seed, device, args.verbose)
