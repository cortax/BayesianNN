...
def main(ensemble_size=1,lat_dim=5,HN_layerwidth=50,init_w=.2, kNNE=0, n_samples_NNE=500, n_samples_KDE=1000, n_samples_ED=50, n_samples_LP=50, max_iter=100000, learning_rate=0.03, min_lr=0.000001, patience=10, lr_decay=0.5,  device=None, verbose=False,show_metrics=False):
    ...
    with mlflow.start_run(run_name=entropy_mthd):#run_name=entropy_mthd'GeNVI-KDE', experiment_id=expdata.experiment_id
...
main(args.ensemble_size,args.lat_dim,args.layerwidth, args.init_w, args.NNE, args.n_samples_NNE, args.n_samples_KDE, args.n_samples_ED, args.n_samples_LP, args.max_iter, args.learning_rate, args.min_lr, args.patience, args.lr_decay, device, args.verbose,args.show_metrics)
